...
function stonedthemes_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'      => esc_html__('Contact Form by WPForms – Drag & Drop Form Builder for WordPress','collective'),
            'slug'      => 'wpforms-lite',
            'required'  => false,
        ),
        array(
            'name'      => esc_html__('One Click Demo Import','collective'),
        ...
        array(
            ...
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
            'version'            => '6.7.4', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
        ),
        array(
            'name'               => esc_html__('Advanced Custom Fields','collective'), // The plugin name.
            'slug'               => 'advanced-custom-fields-pro', // The plugin slug (typically the folder name).
            'source'             => get_template_directory_uri() . '/tgm/plugins/acf.zip', // The plugin source.
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
            'version'            => '6.2.9', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
        ),
    );
